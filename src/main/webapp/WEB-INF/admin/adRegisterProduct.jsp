                                ...
                                <div class="card shadow">
                                    <div class="card-body">
                                        <div class="book_input row mb-2">
                                            <div class="col-3 input_label">상품 제목</div>
                                            <div class="col"><input typle="text" name="bookname" id="bookname" /></div>
                                        </div>
                                        <div class="book_input row mb-2">
                                            <div class="col-3 input_label">상품 등록할 도서 검색</div>
                                            <div class="col"><input typle="text" name="bookname" id="bookname" /></div>
                                        </div>
                                        <div class="book_input row mb-2">
                                        ...
                                        <div class="book_input row mb-2">
                                            ...
                                            <div class="col"><input typle="text" name="bookname" id="bookname" placeholder="5 입력 시 할인율 5% 적용" /></div>
                                        </div>
                                        <div class="book_input row mb-2">
                                            <div class="col-3 input_label">적용된 금액</div>
                                            <div class="col"><input typle="text" name="bookname" id="bookname" readonly/></div>
                                        </div>
                                        <div class="book_input row mb-2">
                                            <div class="col-3 input_label">출간 정보(출간일)</div>
                                            <div class="col"><input typle="text" name="bookname" id="bookname" placeholder="예) 2022.03.02"/></div>
                                        </div>
                                        ...
                                        <div class="book_input row mb-2">
                                            ...
                                            <div class="col mb-1 d-flex align-items-center">
	                                            ...
	                                            <input type="radio" name="readerValid" id="readerValidY" class="reader mr-2">
	                                            <i class="fa-solid fa-headphones h3 mr-2"></i>
	                                            <span class="mr-2">불가능</span>
	                                            <input type="radio" name="readerValid" id="readerValidN" class="reader">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="book_input row mb-2">
