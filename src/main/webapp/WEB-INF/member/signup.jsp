		...
		<div class="signup-before d-flex flex-column justify-content-center align-items-center mt-5">
			<form action="#" method="post">
				<div class="d-flex flex-column flex-wrap align-items-start">
					...
					<div class="form-group" style="width:100%">
						<input type="password" class="form-control" id="pwd_first" placeholder="비밀번호">
						<input type="password" class="form-control" id="pwd_second" placeholder="비밀번호 확인">
					...
					<div class="form-group d-flex d-nowrap" style="width:100%">
						<div class="" style="width:100%">
							<input type="number" class="form-control" placeholder="출생년도 (예:2022)" id="birthyear" maxlength="4" style="width:100%">
					...
					<div class="form-group mb-1" style="width:100%">
						<input type="text" class="form-control" placeholder="휴대전화 번호 입력" id="phone_no" />
